        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('name_project', "", array('class' => 'form-control'.($errors->has('name_project') ? ' is-invalid':''), 'id' => 'name_project', 'maxlength' => 255)) !!}
                    @error('name_project')
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::text('start_date', "", array('class' => 'form-control datepicker'.($errors->has('start_date') ? ' is-invalid':''), 'maxlength' => 10, 'id' => 'start_date', 'autocomplete'=>'off')) !!}
                    @error('start_date')
                    <div class="text text-danger text-sm">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    {!! Form::text('end_date', "", array('class' => 'form-control datepicker'.($errors->has('end_date') ? ' is-invalid':''), 'maxlength' => 10, 'id' => 'end_date', 'autocomplete'=>'off')) !!}
                    @error('end_date')
                    <div class="text text-danger text-sm">{{ $message }}</div>
                    @enderror
                </div>
